...
export function Input(props: InputProps) {
  return (
    <RACInput
      ...
      className={composeTailwindRenderProps(
        props.className,
        "px-2 py-1.5 flex-1 min-w-0 outline-0 bg-white dark:bg-zinc-900 text-sm text-gray-800 dark:text-zinc-200 disabled:text-gray-200 dark:disabled:text-zinc-600"
      )}
    />
  );
}
